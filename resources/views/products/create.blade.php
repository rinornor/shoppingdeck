            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex justify-center">
               ...
               <form class="max-w-sm mx-auto" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-5 mb-5">
                        ...
                        <input type="file" id="image"  name="image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="image.jpg" required accept=".jpg, .jpeg, .png, .webp" />
                    </div>
                    <div class="mt-5 mb-5">
